...
abstract class Platform {
  ...
  abstract List<? extends Converter.Factory> defaultConverterFactories();
  ...
  private static final class Android24 extends Platform {
    private final List<? extends Converter.Factory> defaultConverterFactories =
        singletonList(new OptionalConverterFactory());
    ...
    @Override
    List<? extends Converter.Factory> defaultConverterFactories() {
      return defaultConverterFactories;
    }

    static List<? extends CallAdapter.Factory> defaultCallAdapterFactories(
        CallAdapter.Factory defaultFactory) {
      return asList(new CompletableFutureCallAdapterFactory(), defaultFactory);
    }
